...
public class FavouriteAdapter extends RecyclerView.Adapter<FavouriteAdapter.HotelViewHolder> implements Serializable {
    ...
    public void onBindViewHolder(@NonNull final HotelViewHolder holder, final int position) {
        ...
        holder.btnAddToFavourites.setOnClickListener(new View.OnClickListener() {
            @Override
